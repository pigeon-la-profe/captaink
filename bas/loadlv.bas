...
200le=PEEK(tp):pu=0:DIMHI(14,3):km=0:kn=0:ks=0:ld=0:h4=0:ck=27:lk=0:pm=0:p1=0:p2=0:py=0:px=0:pz=0:ph=3
...
30950RETURN
40000'le,pu,HI(),lk,km,kn,ks,ld,h4,ck,pm,p1,p2,py,px,pz,ph
...
41070 tq=32:FORI=0TO13:FORE=0TO2:POKE tp+tq,HI(I,E):tq=tq+1:NEXTE:NEXTI'HI
41080 load"captainc.bas",r
41090'load"captain1.bas",r
