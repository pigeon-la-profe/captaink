...
210sc=le\40:sc$=RIGHT$(STR$(sc),LEN(STR$(sc))-1):IFsc<>c2THENVDP(1)=VDP(1)AND191:BLOAD"C"+sc$+".sc2",S:POKEtp+77,sc
300DIMPL(14,3):DIMC0(1,9):DIMC1(6,2):DIMM0(1,4):DIMM1(4,2):DIMR1(4,3):DIMC(101):ld=0
500'OPEN"levels11.dat"AS#1LEN=4:FIELD #1,2 as b$:FORi=1to101:get#1,i+le*(101):C(i-1)=CVI(b$):NEXTi:CLOSE#1:GOSUB20000:GOSUB30000
501OPEN"L"+sc$+".dat"AS#1LEN=4:FIELD #1,2 as b$:FORi=1to101:get#1,i+(lemod40)*(101):C(i-1)=CVI(b$):NEXTi:CLOSE#1:GOSUB20000:GOSUB30000
