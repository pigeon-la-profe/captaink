...
3040CX=16:CY=-24:pt(1)=12:pt(2)=24:pt(3)=36:pt(4)=30:nu=1:rt=5:tc=10:wi=0:tp=0:ta=0:et=0:tt=128:tf=1:tb=0:GOSUB11000:T$=STR$(pu):tx=25:ty=22:tq=7:GOSUB9990
4000S=STICK(0):IFS=0THENS=STICK(1)'mloop
5200IFS=3ORS=2ORS=4THENPO=0:ur=ur+1:FA=0
5210IFS=7ORS=6ORS=8THENPO=1:ur=ur+1:FA=1
5220IFur>7ANDPO=0ANDsa=0ANDCL(2)=0THENCX=CX+3:it=it+3:it=itmod12:ur=0:GOSUB14000:GOSUB9600:GOSUB14900ELSEIFur>7ANDPO=0ANDsa=0THENGOSUB14030
5225IFur>7ANDPO=1ANDsa=0ANDCL(3)=0THENCX=CX-3:it=it+3:it=itmod12:ur=0:GOSUB14000:GOSUB9600:GOSUB14900ELSEIFur>7ANDPO=1ANDsa=0THENGOSUB14050
...
15120IFwi=6THENle=le+1:IFle>31THENle=0
15130GOTO18900
...
18900_turbooff
18910_turboon
18920RESTORE18930:FORI=12TO23:READE:VPOKE6144+I+32*10,E:NEXTI:FORI=12TO25:VPOKE6144+I+32*12,0:NEXTI
18930DATA44,47,33,36,41,46,39,0,0,0,0,0
18990_turbooff
