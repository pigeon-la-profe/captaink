...
3010DIMpt(5):DIMCL(8):DIMRY(10):DIMTK(2):DIMTR(6):DIMCF(6,2)
...
5220IFur>10-ix*2ANDPO=0ANDsa=0ANDCL(2)=0THENCX=CX+ix:GOSUB14000ELSEIFur>7-ixANDPO=0ANDsa=0THENGOSUB14030
5225IFur>10-ix*2ANDPO=1ANDsa=0ANDCL(3)=0THENCX=CX-ix:GOSUB14000ELSEIFur>7-ixANDPO=1ANDsa=0THENGOSUB14050
5227ifOP<>POTHENix=1:iy=0'IFPO>1THENix=1:iy=0
...
14000OP=PO:it=it+3:it=itmod12:ur=0:iy=iy+1:IFiy>3THENix=ix+1:iy=0
14002IFix>3THENix=3
