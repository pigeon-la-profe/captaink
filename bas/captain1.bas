...
110hm=0:POKEVAL("&H"+HEX$(VARPTR(hm))),PEEK(&HFC4A):POKEVAL("&H"+HEX$(VARPTR(hm)+1)),PEEK(&HFC4B):SOUND7,191
...
7820IFAR>1ANDsa=0ANDp6=0THENCY=CY+sp:AR=0:it=FA*3:PO=4:GOSUB9600:IFCL(0)=1THEN:si=1:su=5:fe=2:GOSUB14970
7830RETURN
8000'SA
...
14150IFtm>4ANDh4=2THENFORI=0TO7:VPOKE8192+lK*8+I,RND(1)*16:VPOKElK*8+I,(VPEEK(lK*8+I))+(RND(1)*2-2):NEXTI
14160IFtm>4THENtm=0
