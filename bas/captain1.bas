...
3050GOSUB4000'IFTIME>1THENGOSUB4000
...
5220IFur>4ANDPO=0ANDsa=0ANDCL(2)=0THENCX=CX+ix:it=it+3:it=itmod12:ur=0:GOSUB14000:GOSUB9600:GOSUB14900ELSEIFur>4ANDPO=0ANDsa=0THENGOSUB14030
5225IFur>4ANDPO=1ANDsa=0ANDCL(3)=0THENCX=CX-ix:it=it+3:it=itmod12:ur=0:GOSUB14000:GOSUB9600:GOSUB14900ELSEIFur>4ANDPO=1ANDsa=0THENGOSUB14050
5227IFPO>1THENix=1
...
7820IFAR>0ANDsa=0ANDp6=0THENCY=CY+sp:AR=0:it=FA*3:PO=4:GOSUB9600:IFCL(0)=1THEN:si=1:su=5:fe=2:GOSUB14970
7830RETURN
8000'SA
...
8130IFco=1ANDCL(2)=0THENCX=CX+2:it=0:GOSUB14000
8140IFco=2ANDCL(3)=0THENCX=CX-2:it=0:GOSUB14000
8150GOSUB9600
...
14000ix=ix+1:ifix>3thenix=3
14005IFCX>240THENCX=240
