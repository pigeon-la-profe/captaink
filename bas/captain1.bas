...
900le=0:pu=0:DIMHI(14,3):km=0:kn=0:ks=0:ld=0:h4=0:ck=27:lk=0:pm=0:p1=0:p2=0:py=0:px=0:pz=0:ph=3:cs=11:wi=0:GOSUB30800:vdp(4)=0:vdp(3)=159:R=RND(-TIME):IFPEEK(&H002B)>128THENde=3000ELSEde=3600
3000_turboon(le,pu,HI(),lk,km,kn,ks,ld,h4,ck,pm,p1,p2,py,px,pz,ph,cs,de,wi)
