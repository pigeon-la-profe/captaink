...
8170IF(fr>szORCL(0)=1ORCL(1)=1ORCL(2)=1ORCL(3)=1)THENfr=0:sr=0:fr=0:co=0:sa=0:su=5:si=1:fe=2:IFfr<=szTHENGOSUB14970
8200RETURN
...
14030IF(C3>kmANDC3<kn)AND(C4<=kmORC4>=kn)ANDCX<240THENCX=CX+4:CY=CY-8:GOSUB14000:RETURNELSERETURN
14050IF(C6>kmANDC6<kn)AND(C5<=kmORC5>=kn)THENCX=CX-4:CY=CY-8:GOSUB14000:RETURNELSERETURN
