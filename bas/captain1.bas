...
900le=0:pu=0:DIMHI(14,3):km=0:kn=0:ks=0:ld=0:h4=0:ck=27:lk=0:pm=0:p1=0:p2=0:py=0:px=0:pz=0:ph=3:cs=11:wi=0:tl=0:GOSUB30800:vdp(4)=0:vdp(3)=159:R=RND(-TIME):IFPEEK(&H002B)>128THENde=3000ELSEde=3600
...
3040CX=16:CY=-24:pt(1)=12:pt(2)=24:pt(3)=36:pt(4)=30:nu=1:rt=5:tc=10:tp=0:ta=0:et=0:tt=128:tf=1:tb=0:GOSUB11000:T$=STR$(pu):tx=25:ty=22:tq=7:GOSUB9990
3050IFTIME>1THENGOSUB4000
...
5220IFur>2ANDPO=0ANDsa=0ANDCL(2)=0THENCX=CX+3:it=it+3:it=itmod12:ur=0:GOSUB14000:GOSUB9600:GOSUB14900ELSEIFur>2ANDPO=0ANDsa=0THENGOSUB14030
5225IFur>2ANDPO=1ANDsa=0ANDCL(3)=0THENCX=CX-3:it=it+3:it=itmod12:ur=0:GOSUB14000:GOSUB9600:GOSUB14900ELSEIFur>2ANDPO=1ANDsa=0THENGOSUB14050
...
7510RETURN'IFTIME>2THENGOSUB14100
7530ws=ws+3:ifws>32thenws=32
7540return
...
8119IFp6=1THENim=0
8120sr=sr+1:IFsr>0THENfr=fr+1:CY=CY-im:CY=CYMOD192:sr=0ELSEGOTO8160
8130IFco=1ANDCL(2)=0THENCX=CX+2:GOSUB14000
8140IFco=2ANDCL(3)=0THENCX=CX-2:GOSUB14000
8150GOSUB9600
8160IFfr<3ANDCL(1)=0GOTO8200
8170IF(fr>szORCL(0)=1ORCL(1)=1ORCL(2)=1ORCL(3)=1)andCY+16>0THENfr=0:sr=0:fr=0:co=0:sa=0:su=5:si=1:fe=2:GOSUB14970
8200RETURN
