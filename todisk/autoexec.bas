...
30BLOAD"splashdi.sc2",S:VDP(1)=VDP(1)OR64:tl=35:le=0
40_turboon(le)
50TIME=0
...
150POKEtp,le:POKEtp+1,tl:POKEtp+2,0:POKEtp+3,0:LOAD"loadlvc.bas",r
160'POKEtp,le:POKEtp+1,tl:POKEtp+2,0:POKEtp+3,0:LOAD"loadlv.bas",r
